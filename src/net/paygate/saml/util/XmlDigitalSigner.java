...
public class XmlDigitalSigner {
	...
	public static final String JSR_105_PROVIDER = "org.jcp.xml.dsig.internal.dom.XMLDSigRI";
	public static final String SAML_PROTOCOL_NS_URI_V20 = "urn:oasis:names:tc:SAML:2.0:protocol";
	...
	private static Element signSamlElement(Element element, PrivateKey privKey,
		...
		try {
			...
			throw new SamlException("Error signing SAML element: "
					+ e.getMessage());
